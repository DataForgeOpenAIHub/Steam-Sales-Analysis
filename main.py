...
csv_file_path = "./data/download/app_list.csv"
...
if all_data:
    ...
    updated_data.to_csv(csv_file_path, header=True, index=False)
    print(f"All new data appended and sorted to {csv_file_path}")
    print(f"Number of new entries added: {new_data_count}")
else:
    print("No new data to append.")

app_list_df = pd.read_csv(csv_file_path)
